...
namespace AirBookings.DataAccess
{
    public class DbInitializer : DropCreateDatabaseAlways<AirBookingsContext>
    {
        protected override void Seed(AirBookingsContext context)
        {
            ...
            context.Seats.Add(new Seat() { Id = 1, AircraftId = 1, SeatNumber = "1A" });
            context.Seats.Add(new Seat() { Id = 2, AircraftId = 1, SeatNumber = "1B" });
            context.Seats.Add(new Seat() { Id = 3, AircraftId = 1, SeatNumber = "1C" });
